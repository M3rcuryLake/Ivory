import sys, os, datetime, markdown, frontmatter, glob, shutil
...
def Build():
    ...
    for item in os.listdir('layouts/'):
        if item.startswith('_'):
            shutil.copy("layouts/"+item, "./public/")
    ...
    stylesPermalink=f'{baseURL}css/pico.min.css'    
...
#--------------------------------------------------
    ...
    for item in tree_files:
        ...
        base_body=open('./public/'+item[:-3]+".html", "x")
